...
# 获取出歌手余额信息
def get_singer_money(cookie:str):
    uri = "/weapi/nmusician/workbench/creator/wallet/overview"
    csrf_value = cryptos.cookie_get_csrf(cookie)
    body_json = {
        "csrf_token": csrf_value
    }
...
# 获取余额来源
# source 独家激励金 120 点播分成 140 会员包 162 广告分成 110
def get_singer_wallet_detail(cookie:str):
    uri = "/weapi/nmusician/workbench/income/wallet/source/amount"
    csrf_value = cryptos.cookie_get_csrf(cookie)
    body_json = {
        "csrf_token": csrf_value
    }
...
# 总播放量
def statistics_count(cookie:str):
    uri = "/weapi/nmusician/statistics/songs/total"
    csrf_value = cryptos.cookie_get_csrf(cookie)
    body_json = {
        "csrf_token": csrf_value
    }
...
if __name__ == "__main__":
    ...
    # print(get_singer_wallet_detail(cookie))
    print(statistics_count(cookie))
